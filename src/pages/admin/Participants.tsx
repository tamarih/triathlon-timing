...
const S = {
  ...
  tableWrap: { background: 'white', borderRadius: 16, boxShadow: '0 2px 12px rgba(0,0,0,0.07)', overflowX: 'auto' as const, overflowY: 'visible' as const, WebkitOverflowScrolling: 'touch' as const },
  table: { width: '100%', minWidth: 1150, borderCollapse: 'collapse' as const, fontSize: 13 },
